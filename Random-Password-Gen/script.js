function generatePassword() {
    ...
    while (charTypeSelected == false) {
      ...
      if ((lowerCase) || (upperCase) || (numericCharacters) || (specialCharacters)) {
        ...
        window.alert("Select One Character type.")
      }
    }
  ...
  function getPasswordLength() {
    var userChoice = 0;
    while ((userChoice < 10) || (userChoice > 128)) {
      userChoice = parseInt(window.prompt("Enter the number of characters between 10 and 128: "));
        if (isNaN(userChoice)) {
        userChoice = 0;
      }
    }
